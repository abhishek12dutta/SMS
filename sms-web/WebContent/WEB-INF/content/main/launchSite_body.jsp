...
<div class="newsHeader"><h3>Latest News</h3></div>
	<div class="newsSection">
		<ul>
			<li>
				<div class="sidebar_item">
					<h4>New Website Launched 1</h4>
					<h5>January 1st, 2012</h5>
					<p>
						2012 sees the redesign of our website. Take a look around and let
			...
			<li>
				<div class="sidebar_item">
					<h4>New Website Launched 3</h4>
					<h5>January 1st, 2012</h5>
					<p>
						2012 sees the redesign of our website. Take a look around and let
						us know what you think2012 sees the redesign of our website. Take a look around and let
						us know what you think2012 sees the redesign of our website. Take a look around and let
						us know what you think.<br> <a href="#">Read more</a>
					</p>
				</div>
...
<div class="content">
	<h1>Welcome to the CSS3_one Template</h1>
	<div class="content_item">
		<p>
			This simple, fixed width website template is released under a <a
				href="http://creativecommons.org/licenses/by/3.0">Creative
				Commons Attribution 3.0 Licence</a>. This means you are free to download
			and use it for personal and commercial projects. However, you <strong>must
